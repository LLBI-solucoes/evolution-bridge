...
class EvolutionBridge {
    constructor(config, retryConfig = {}) {
        ...
        this.retryConfig = {
            ...
            shouldRetry: retryConfig.shouldRetry || ((error) => {
                return axios_1.default.isAxiosError(error) && (!error.response || error.response.status >= 500);
            })
        };
    ...
    setupInterceptors() {
        ...
        this.client.interceptors.response.use((response) => response, (error) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!originalRequest || !((_b = (_a = this.retryConfig).shouldRetry) === null || _b === void 0 ? void 0 : _b.call(_a, error))) {
                return Promise.reject(error);
            }
